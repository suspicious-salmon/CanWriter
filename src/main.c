...
int main(void)
{
  ...
  msg_len = sprintf(uart_msg_buf, "Starting CAN transmission...\r\n");
  ...
  while (1)
  {
    ...
    // PROGRESS NOTE: errors on 4th attempt. we think the 3 mailboxes are filling up then it throws an error.
